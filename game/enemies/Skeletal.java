...
/**
 * A type of enemy that has skeletal properties
 * Created by:
...
public abstract class Skeletal extends Enemy {
     ...
     * @param max_runes
     */
    public Skeletal(String name, char displayChar, int hitPoints, int min_runes, int max_runes) {
    ...
    public String getDeathAction(Actor target, GameMap map) {
        ...
        targetLocation.addActor(new PileOfBones(this));
        return this.name + " is replaced by Pile of Bones\n";
    }
}
